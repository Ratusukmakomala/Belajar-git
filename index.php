...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css" />
    ...
    <body>
       ...
       ?>
        ...
        <h1 style="margin-top:35px;" class="center weight">RAIS Marketplace Arsitek Website</h1>
        <h4 style="font-size: 16px;margin-top:-20px;" class="center">
           Selamat Datang  Anda Dapat Melihat & Memilih Design Rumah Yang Telah Dibuat Arsitek!
        </h4>

...
<html>
	<head>
		<meta charset="utf8" />
		<title>Create Sandbox User call Page |RAIS Marketplace Arsitek Website</title>
    ...
    <body style="margin:20px;" onload="load()">
      ...
      ?>
        ...
        <h1 class="weight center" style="margin-top:35px;">Create Sandbox User call Page - RAIS Marketplace Arsitek Website</h1>
        <div id="testcalls">
            <hr class="divider">
...
$httpcode = curl_getinfo($curl, CURLINFO_HTTP_CODE);
                ...
                if ($err) {
                 ...
                 $json_pretty = json_encode(json_decode($permintaan), JSON_PRETTY_PRINT);
                echo $json_pretty;
...
-->
        <script>var textedJson = JSON.stringify(permintaan, undefined, 4);

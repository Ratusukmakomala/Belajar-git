...
<html>
	<head>
		<meta charset="utf8" />
		<title>Delete Sandbox call Page | RAIS Marketplace Arsitek Website</title>
    ...
    <body style="margin:20px;" onload="load()">
      ...
      ?>
        ...
        <h1 style="margin-top:35px;" class="weight center">Export Sandbox call Page - RAIS Marketplace Arsitek Website</h1>
        <div id="testcalls">
            <hr class="divider">
        <h3 style="font-size:32px;" class="center weight">
            Permintaan <span style="color:#015563">Pelanggan:</span>
        </h3> </div>
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "content-type: application/json"
            ...
            if ($err) {
               ...
               if ($httpcode==204){echo 'Sandbox deleted successfully! (Warning: This is a custom written message - usually there is no response in Delete Calls.)';}
                echo $response;
            }; ?>
        </textarea>
<!--
...
-->
        <script type="text/javascript">
            function load()
            {
                window.location.href = "/deletesandbox.php#popup1";
            }
        </script>
<!--
